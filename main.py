...
print('======================================')
print('Aviso: a saida de dados e feita com base em 1 ano')
...
def empresa():
    ...
    dadosEmpresa = {} #Armazenamento dos dados da empresa
    dadosEmpresa['nome'] = (input('Nome da organização: ')) #entrada do nome da empresa
    dadosEmpresa['endereco'] = (input('Endereço da organização: ')) #entrada do endereço da empresa
    dadosEmpresa['nomeResponsavel'] = (input('Nome do responsável: ')) #entrada do nome do responsável pela empresa
    dadosEmpresa['telefoneResponsavel'] = (input('Telefone do Responsável: ')) #entrada do Telefone do responsável pela empresa
    while True:
        anoInventariado = int(input('Ano Inventariado: '))
        if 2006 <= anoInventariado <= 2023:
            dadosEmpresa['anoInventario'] = (anoInventariado) #ano de inventario
            break
        else:
